 ...
 */
var age = 21; // this assigns the value 21 to the age variable
/***
 VARIABLES
...
/***
 ...
 Items in an object can be both added and accessed using the [] (Square Bracket Notation) similar to an Array.
 */
var pet = { breed: "Black Lab", name: "Toby" };
pet.name = "Molly";
